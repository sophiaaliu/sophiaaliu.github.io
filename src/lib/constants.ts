...
export const DO_OPTIONS = [
  {
    label: "Advocates for user-centered design",
    value: "advocate",
  },
  {
    label: "Balances user and business goals",
    value: "balance",
  },
  {
    label: "Creates delightful user experiences",
    value: "create",
  },
];

export const LANDING_PAGE_ABOUT =
